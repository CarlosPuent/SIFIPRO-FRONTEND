...
import type { TopRedeemedRewardResponse } from "../dashboard.types";

type TopRedeemedRewardsTableProps = {
  rewards: TopRedeemedRewardResponse[];
};

export function TopRedeemedRewardsTable({
  rewards,
}: TopRedeemedRewardsTableProps) {
  return (
